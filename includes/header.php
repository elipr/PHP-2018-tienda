<nav class="navbar navbar-inverse">
            <div class="container-fluid">
                <!-- logo -->
                <div class="navbar-header" style="background-color:#fff; padding-left: 8px">
                ...
                <div class="collapse navbar-collapse" id="top-menu">
                    ...
                    <ul class="nav navbar-nav">
                        <li><a href="index.php"><i class="fas fa-home" style="color:#fff"></i>Home</a></li>
                    ...
                    <p class="navbar-text navbar-right" style="display:none">Bienvenido</p>
